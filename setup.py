...
MODULE_SLUG = "gold_rush"

setup(
    name=MODULE_SLUG,
    version="0.1.0",
    author="Marcelo Alonso e Luigi Lopes",
    author_email="marcelovta@al.insper.edu.br",
    description="gold *o*",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/Marcelo-vta/corrida do ouro",  # URL do repositório do seu projeto (se houver)
    ...
    entry_points={
        'console_scripts': [
            f'gold_rush-cli={MODULE_SLUG}.main:app',
        ],
    },
